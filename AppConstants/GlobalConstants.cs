    ...
    public static class GlobalConstants
    {
        ...
        public static string MailChimpAPIKey
        {
            get
            {
                ...
                return WebConfigurationManager.AppSettings["MailChimpAPIKey"].ToString();
            }
        }
        public static string MailChimpListId
        {
            get
            {
                ...
                return WebConfigurationManager.AppSettings["MailChimpListId"].ToString();
            }
        }
        ...
        public static string IcePayGiftCardTranSuccessNl
        {
            get
            {

                return WebConfigurationManager.AppSettings["IcePayGiftCardTranSuccessNl"];
            }
        }
        public static string IcePayGiftCardTranErrorNl
        {
            get
            {

                return WebConfigurationManager.AppSettings["IcePayGiftCardTranErrorNl"];
            }
        }
