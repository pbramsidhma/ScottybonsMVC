...
namespace ScottybonsMVC.Models.ViewModels.Customer
{
    public class OrderVm : RenderModel
    {
       ...
       [Required]
        ...
        [Required(ErrorMessageResourceType = typeof(ScottybonsDataStrings), ErrorMessageResourceName = "PhoneNumberRequired")]
        ...
        [DataType(DataType.PhoneNumber, ErrorMessageResourceType = typeof(ScottybonsDataStrings), ErrorMessageResourceName = "PhoneNumberRequired")]
